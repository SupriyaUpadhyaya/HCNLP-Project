...
def invoke_chain(question,messages,tokenizer,model,contextRetriever, follow_up=False):
    ...
    new_context = contextRetriever.get_table_context_and_rows_str(question,st.session_state.topk)
    if follow_up:
...
Answer:'''
 ...
 Answer:'''
    ...
    log_content = write_log(question, selected_tables, exec_result, answer, prev_hist, is_refined, refined_generations)  
